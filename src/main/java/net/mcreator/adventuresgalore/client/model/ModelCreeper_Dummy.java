...
public class ModelCreeper_Dummy extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("adventures_galore", "model_creeper_dummy"), "main");
	public final ModelPart CreeperDummy;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition CreeperDummy = partdefinition.addOrReplaceChild("CreeperDummy", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Body = CreeperDummy.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -18.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
